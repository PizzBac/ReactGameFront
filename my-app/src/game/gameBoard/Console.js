      ...
      <div className="console">
        <div className="line-1">
          <div className="wrapper">
            ...
            <div className="hex btn-assassin">
              <div className="hex-inner1">
        ...
        <div className="line-3">
          <div className="wrapper">
            <div className="hex btn-ambassador">
              <div className="hex-inner1">
